	...
	mDHTxType(DHTxTYPE::DHT11)
{
	...
	mLongPulseInterface->SetTitleAndTooltip("One Valued Pulse Duration (microseconds)", "Specify the duration of a One pulse (�s).");
	...
	mShortPulseInterface->SetTitleAndTooltip("Zero Valued Pulse Duration (microseconds)", "Specify the duration of a Zero pulse (�s).");
